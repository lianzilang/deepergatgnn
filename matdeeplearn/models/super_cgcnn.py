...
# from torch_geometric.nn import Set2Set, global_mean_pool, global_add_pool, global_max_pool, CGConv, DiffGroupNorm
# from torch_scatter import scatter_mean, scatter_add, scatter_max, scatter


class SUPER_CGCNN(paddle.nn.Layer):
    ...
    def __init__(self, data, dim1=64, dim2=64, pre_fc_count=1, gc_count=3,
        ...
        for i in range(gc_count):
            conv = CGConv(gc_dim, data.num_edge_features, aggr='mean',
                batch_norm=False)
