...
>>>>>>    optimizer = getattr(torch.optim, model_parameters['optimizer'])(model.
        parameters(), lr=model_parameters['lr'], **model_parameters[
        'optimizer_args'])
...
>>>>>>        optimizer = getattr(torch.optim, model_parameters['optimizer'])(model
            .parameters(), lr=model_parameters['lr'], **model_parameters[
            'optimizer_args'])
>>>>>>        scheduler = getattr(torch.optim.lr_scheduler, model_parameters[
            'scheduler'])(optimizer, **model_parameters['scheduler_args'])
