...
from torch_geometric.nn import Set2Set, global_mean_pool, global_add_pool, global_max_pool, GCNConv, DiffGroupNorm
...
class DEEP_GATGNN(paddle.nn.Layer):
    ...
    def forward(self, data):
        ...
        for i in range(0, len(self.conv_list)):
            if len(self.pre_lin_list_N) == 0 and i == 0:
                ...
                out_x = self.conv_list[i](out_x, data.edge_index, out_e)
            out_x = paddle.add(x=out_x, y=paddle.to_tensor(prev_out_x))
